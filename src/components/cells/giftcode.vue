<template>
    <div class="page">
        ...
        <!-- 兑换开始 -->
        <div class="form">
            <input type="text" placeholder="输入礼物码兑换并使用" class="fcode">
            <a href="javascript;">
                兑换
            </a>
        </div>
...
.form{
    ...
    position: relative;
    padding: 0.26rem 4rem 0.39rem 0.9425rem;
    .fcode{
